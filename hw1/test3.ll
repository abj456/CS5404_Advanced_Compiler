...
for.body:                                         ; preds = %entry, %for.inc
  ...
  %arrayidx4 = getelementptr inbounds [40 x i32], ptr %D, i64 0, i64 %idxprom3
  %1 = load i32, ptr %arrayidx4, align 4
  %mul = mul nsw i32 2, %i.01
  %sub = sub nsw i32 %mul, 3
  %idxprom5 = sext i32 %sub to i64
  %arrayidx6 = getelementptr inbounds [40 x i32], ptr %B, i64 0, i64 %idxprom5
  store i32 %1, ptr %arrayidx6, align 4
  %mul7 = mul nsw i32 2, %i.01
  %sub8 = sub nsw i32 %mul7, 4
  %idxprom9 = sext i32 %sub8 to i64
  %arrayidx10 = getelementptr inbounds [40 x i32], ptr %A, i64 0, i64 %idxprom9
  %2 = load i32, ptr %arrayidx10, align 4
  %idxprom11 = sext i32 %i.01 to i64
  %arrayidx12 = getelementptr inbounds [40 x i32], ptr %D, i64 0, i64 %idxprom11
  store i32 %2, ptr %arrayidx12, align 4
  %mul13 = mul nsw i32 2, %i.01
  ...
  %sub17 = sub nsw i32 %i.01, 1
  %idxprom18 = sext i32 %sub17 to i64
  %arrayidx19 = getelementptr inbounds [40 x i32], ptr %D, i64 0, i64 %idxprom18
